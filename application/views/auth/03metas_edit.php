        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">
                    <?php echo isset($title) ? $title : "Modificacion de Metas";?>
                </h5>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="card border-light  ">
                    ...
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h4 class="card-label">
                                <?php echo isset($Subtitle) ? $Subtitle : "Metas";?>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background: white">
                                                <h5 class="modal-title" id="editModalLabel">Editar descripcion de Meta
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <form id="editForm">
                                                    <div class="form-group">
                                                        <label for="editLineaAccion">Meta:</label>
...
$(document).ready(function() {
    ...
    $("#saveChangesBtn").on("click", function() {
        ...
        $.ajax({
            url: "<?= base_url() ?>Auth/guardarDescMeta",
            type: "POST",
            data: {
                id: id,
